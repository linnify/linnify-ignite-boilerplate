...
`);
  ...
  print.info(logo)
  const spinner = print
    .spin(`using the TypeScript boilerplate from Linnify Agency. You might want to make a cuppa while we get this ready. ☕️`)
    .succeed()
  ...
  try {
    ...
    const boilerplate = parameters.options.b || parameters.options.boilerplate || 'ignite-react-native-linnify'
